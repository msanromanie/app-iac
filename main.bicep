...
@minLength(3)
@maxLength(30)
param appServiceAppName1 string = 'manuelsanroman-assignment-prod-be'
@sys.description('The Web App name.')
@minLength(3)
@maxLength(30)
param appServiceAppName3 string = 'manuelsanroman-assignment-prod-fe'
@sys.description('The App Service Plan name.')
@minLength(3)
@maxLength(30)
param appServicePlanName1 string = 'manuelsanroman-assignment-prod'
@sys.description('The Web App name.')
@minLength(3)
@maxLength(30)
param appServiceAppName2 string = 'manuelsanroman-assignment-dev-be'
@minLength(3)
@maxLength(30)
param appServiceAppName4 string = 'manuelsanroman-assignment-dev-fe'
@sys.description('The App Service Plan name.')
@minLength(3)
@maxLength(30)
param appServicePlanName2 string = 'manuelsanroman-assignment-dev'
@sys.description('The Storage Account name.')
@minLength(3)
@maxLength(30)
param storageAccountName string = 'manuelsanroman-assignment-storage'
@allowed([
  'nonprod'
  'prod'
  ])
